...
class PushNotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create push_notification" do
    assert_difference("PushNotification.count") do
      post push_notifications_url, params: { push_notification: { badge: @push_notification.badge, body: @push_notification.body, sound: @push_notification.sound, title: @push_notification.title } }
    end
  ...
  test "should update push_notification" do
    patch push_notification_url(@push_notification), params: { push_notification: { badge: @push_notification.badge, body: @push_notification.body, sound: @push_notification.sound, title: @push_notification.title } }
